Write-Host "=== FIX ENCODING + CURSOS FORMADOR ===" -ForegroundColor Yellow

# Reescribir completamente el archivo sin ningun caracter especial
...
[System.IO.File]::WriteAllText("$PWD\frontend\src\app\(dashboard)\formador\courses\page.tsx", $content, [System.Text.Encoding]::UTF8)
Write-Host "formador/courses reescrito sin em-dash OK" -ForegroundColor Green
