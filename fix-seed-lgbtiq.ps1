Write-Host "=== FIX SEED LGBTIQ+ (6 personas) ===" -ForegroundColor Yellow

# Los 6 que deben tener genero NO_BINARIO segun el Excel:
# 1. German Arnulfo Antonio           - Sexo=Hombre, Genero=No binario
# 2. Jesus David Ramirez Alvarez      - Sexo=LQTBIQ+
# 3. Gloria Esperanza Gomez Marin     - Sexo=LQTBIQ+
# 4. Alberto Ruiz Ruiz Pardo          - Sexo=LQTBIQ+
# 5. Maria Adalyde Pena Gamboa        - Sexo=LQTBIQ+
# 6. Karen Castano Aventours          - Sexo=LQTBIQ+
...
[System.IO.File]::WriteAllText("$PWD\backend\prisma\seed.js", $seedContent, $utf8NoBom)
Write-Host "seed.js con 6 personas LGBTIQ+ corregido OK" -ForegroundColor Green

Write-Host ""
Write-Host "Distribucion de genero corregida:" -ForegroundColor Cyan
Write-Host "  LGBTIQ+ (NO_BINARIO): German Arnulfo, Jesus David Ramirez, Gloria Esperanza Gomez, Alberto Ruiz, Maria Adalyde Pena, Karen Castano"
Write-Host ""
